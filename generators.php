...
<body>
    ...
    ?>
    <p> A função geradora funciona como um iterador, podendo ser usada num ciclo até que o gerador não tenha mais valores para devolver com o yield.</p>
    <?php  
