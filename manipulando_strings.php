...
<body>
    <div class="container">
        <?php 
            $text1 = "STRINGS são variáveis muito especiais dentro do PHP. Existem dezenas de funções para ratamento de strings. Por exemplo, podemos apresentar um determinado caracter de uma string da seguinte forma: ";
        ...
        <?php 
            echo "O strlen() retorna o número de caracteres de uma string, a frase do primeiro exemplo tem " . strlen($frase) . " caracteres."; ?><br/>
