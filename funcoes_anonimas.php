...
<body>
    <div class="container">
        ...
        <br/>
        <p>
            Funções anônimas -> são funções normalmente simples atribuidas diretamenta as variáveis.
        </p>
        <?php 
        ...
        <p>
            São funções anônimas escritas de uma forma mais curta. Foram introduzidas no PHP 7.4, e tem a especificidade de 
            capturar automaticamente as variáveis globais.
        </p>
