...
<body>
    <div class="container">
        ...
        <p> 
            As funções são blocos de codigo identificadas por um nome e que permitem que o código seja 
            reutilizado e organizado de uma forma muito mais consistente.
        </p>

        <p> Este blocos só serão executados quando solicitados.</p>

        <p> 
            Definimos uma função usando a palavra reservada function, seguida de um nome, um conjunto 
        ...
        <p> 
            Podemos passar para função certos parametros para sua execução, estes vão dentro dos parênteses na chamada 
            da função e são separados por virgula.
        </p>
        <p> Exemplo:</p>
